...
export const CORE_NAVIGATION: NavItem[] = [
  ...
  {
    key: 'cabinet.referals',
    to: '/cabinet/referals',
    label: 'cabinet.tab_referals',
  ...
  {
    key: 'players.playtime',
    to: '/players/playtime',
    label: 'players.tab_playtime',
    icon: 'bx bx-game',
    places: ['players.tabs'],
    order: 20,
    exact: false,
