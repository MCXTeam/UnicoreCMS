<template>
  <div class="cab-grid">
    <div class="cab-col cab-span-7">
      <CabTile :title="$t('cabinet.card_profile')" icon="bx bx-user-circle" bodyClass="cab-profile" class="cab-order-1">
        <template #actions>
        ...
        <div class="cab-profile__info">
          <div class="cab-profile__name">
            <PlayerName :username="$auth.user.username" :roles="$auth.user.roles" />
          </div>
          <div class="cab-rows">
      ...
      <CabTile :title="$t('cabinet.card_privileges')" icon="bx bx-crown" class="cab-order-3">
        <template #actions>
    ...
    <div class="cab-col cab-span-5">
      <CabTile :title="$t('cabinet.card_balance')" icon="bx bx-wallet-alt" accent bodyClass="cab-metrics" class="cab-order-2">
      ...
      <CabTile :title="$t('cabinet.bans_title')" icon="bx bxs-shield-alt-2" class="cab-order-4">
    ...
    <CabTile :title="$t('cabinet.ingame_balances')" icon="bx bx-coin-stack" :span="12" class="cab-order-5">
      <template #actions>
        <NuxtLink to="/cabinet/payment">
          <Button size="small" text><i class="bx bx-transfer me-1"></i> {{ $t('cabinet.tab_payment') }}</Button>
        </NuxtLink>
      </template>
      <div v-if="money === null" class="cab-servers cab-servers--grid">
