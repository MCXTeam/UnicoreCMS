export enum Permission {
  ...
  AdminDashboardStatsPayments = "admin.dashboard.stats.payments",
  ...
  AdminUsersUpdateEmail = "admin.users.update.email",
  ...
  EditorNewsHidden = "editor.news.hidden",
  ...
  UserCabinetUnbanBuy = "user.cabinet.unban.buy",
  UserDonateGroupBuy = "user.donate.group.buy",
  UserDonatePermissionBuy = "user.donate.permission.buy",
  UserCabinet2FAOn = "user.cabinet.2fa.on",
  UserCabinet2FAOff = "user.cabinet.2fa.off",
  UserCabinetPasswordChange = "user.cabinet.password.change",
