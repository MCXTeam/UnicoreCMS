...
export const PERMISSIONS = define({
  ...
  "panel.revenue.read": { group: "dashboard" },
  ...
  "panel.servers.update": { group: "servers" },
  ...
  "panel.donate.read": { group: "donate" },
  "panel.donate.groups.create": { group: "donate" },
  "panel.donate.groups.update": { group: "donate" },
  "panel.donate.groups.delete": { group: "donate" },
  "panel.donate.groups.delete.many": { group: "donate" },
  ...
  "panel.donate.permissions.create": { group: "donate" },
  "panel.donate.permissions.update": { group: "donate" },
  "panel.donate.permissions.delete": { group: "donate" },
  "panel.donate.permissions.delete.many": { group: "donate" },
  ...
  "panel.store.products.create": { group: "store" },
  "panel.store.products.update": { group: "store" },
  "panel.store.products.update.many": { group: "store" },
  "panel.store.products.delete": { group: "store" },
  "panel.store.products.delete.many": { group: "store" },
  "panel.store.products.export": { group: "store" },
  "panel.store.products.import": { group: "store" },
  ...
  "panel.store.kits.create": { group: "store" },
  "panel.store.kits.update": { group: "store" },
  "panel.store.kits.delete": { group: "store" },
  "panel.store.kits.delete.many": { group: "store" },
